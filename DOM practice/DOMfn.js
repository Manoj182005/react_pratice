...
function addBlog(blog) {
  ...
  const newBlockButton = document.createElement("div");
  newBlockButton.className = "blog-buttons";

  const button = document.createElement("button")
  button.className = "blog-button delete";
  button.textContent = "Delete";
  newBlockButton.appendChild(button);

  newBox.appendChild(newBlockButton);
  ...
  button.addEventListener("click", () => { newBox.remove() });
